app.component('photo-search',{
    ...
    <div class="flex justify-center mb-2">
        <input @input="updateRTValue" v-model="tempSearchKeywordsRealtime" @keyup.enter="$emit('do-search')" placeholder="Enter your keywords" id="searchBox" class="pl-1 text-black shadow-inner border border-gray-300 border-opacity-100 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent focus:ring-opacity-70">
